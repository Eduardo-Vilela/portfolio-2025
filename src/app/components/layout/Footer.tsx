      ...
      <Row className='py-5'>
        ...
        {/* <Col lg={12} className='w-100 d-flex flex-row justify-content-center align-items-center'>
          <Button href='#' variant='secondary'>
            <Image src={'/images/logoEdu.png'} alt='' width={100} height={100}/>
          </Button>
        </Col>
        <Col lg={12} className='w-100 d-flex flex-row justify-content-center align-items-center gap-2'>
          <Button href='#' variant='primary' className='border-white'>Linkedin</Button>
          <Button href='#' variant='primary' className='border-white'>Github</Button>
          <Button href='#' variant='primary' className='border-white'>Instagram</Button>
          <Button href='#' variant='primary' className='border-white'>Facebook</Button>
        </Col> */}
